...
Unsupervised learning benaderingen leert anomalieën herkennen gebaseerd op patronen en afwijkend gedrag in de data, zonder nood te hebben aan gelabeld trainingsmateriaal. Anomalieën worden beschouwd als datapunten die afwijken van het dominante gedrag of niet behoren tot een bestaande cluster. Deze algoritmen voegen gegevenspunten samen op basis van overeenkomsten en verschillen. Deze methoden zijn geschikt voor het identificeren van ongekende Anomalieën en het identificeren van complexe patronen in data, maar identificeert meer false positives door gebrek aan gelabelde data en kan mogelijk geen onderscheid maken tussen verschillende Anomalieën.
Semisupervised learning vormt een tussenvorm hierbij wordt het model voornamelijk getraind op niet-gelabelde data, aangevuld met een beperkte hoeveelheid gelabelde gegevens of vooraf gedefinieerde profielen van normaal gedrag. Niet gelabelde data wordt gebruikt om de accuraatheid van het model te verbeteren, terwijl gelabelde data ervoor zorgt dat het algoritme directer anomalieën kan detecteren. Deze methode zorgt ervoor dat de voordelen van unsupervised detectie worden gecombineerd met extra context van gelabelde data, waardoor de detectie van anomalieën wordt verfijnd en het aantal false positives worden gereduceerd \Autocite{Saabith2023}.
Binnen deze drie benaderingen worden er verschillende modellen en technieken toegepast. Voor supervised worden onder meer Support Vector Machines (SVM), Random Forest en neurale netwerkgebaseerde classificatiemodellen genoemd. Unsupervised benaderingen zijn modellen zoals: clustering (k-means, DBSCAN), Principal Component Analysis (PCA), Local Outlier Factor (LOF) en Isolation Forest. En Semi-supervised modellen zijn onder andere: one-class technieken zoals One-Class SVM en Autoencoders modelleren voornamelijk het normale gedrag en beschouwen afwijkingen hiervan als anomalieën.\Autocite{Schummer2024} 
